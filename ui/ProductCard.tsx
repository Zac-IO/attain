...
const ProductCard: React.FC<ProductCardProps> = (props) => {
  ...
  return (
    <View style={[styles.card, {width : itemWidth}]}>
      ...
      <Text style={[styles.price, props.discounted_price && styles.crossed_out]}>${props.price}</Text>
      <Text style={styles.supplier}>Supplier: {props.supplier}</Text>
      {props.discounted_price && (
        <Text style={styles.discountedPrice}>Discounted: ${props.discounted_price}</Text>
      )}
    </View>
  );
};
